...
describe('methods tests', () => {
    ...
    describe('startExport', () => {
        ...
        test('using folders from QuipService.getUser()', async () => {
            ...
            expect(quipProcessor._exportFolders).toHaveBeenCalledWith(folderIdsToExport, false);
        });
    ...
    describe('startExportAnalyze', () => {
        beforeEach(() => {
            const options = {...defaultOptions, analyze: true};
        ...
        test('using analyze option', async () => {
            await quipProcessor.startExport();
            const folderIdsToExport = [
                userFolders.private_folder_id,
                ...userFolders.shared_folder_ids,
            ...
            expect(quipProcessor._exportFolders).toHaveBeenCalledWith(folderIdsToExport, true);
        });
    });
    ...
    describe('startExportSharedFolder', () => {
        ...
        test('using shared folder from QuipService.getUser()', async () => {
            await quipProcessor.startExport();
            expect(quipProcessor._exportFolders).toHaveBeenCalledWith(userFolders.shared_folder_ids, false);
        });
    });
    ...
    describe('startExportGroupFolder', () => {
        ...
        test('using group folder from QuipService.getUser()', async () => {
            await quipProcessor.startExport();
            expect(quipProcessor._exportFolders).toHaveBeenCalledWith(userFolders.group_folder_ids, false);
        });
    });
    ...
    describe('_processDocumentThreadAsDocx', () => {
        beforeEach(() => {
            initQuipProcessor({...defaultOptions, gdrive: true});
        });
